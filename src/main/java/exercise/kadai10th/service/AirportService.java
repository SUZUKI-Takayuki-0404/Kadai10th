...
public interface AirportService {
     ...
     * Returns {@code AirportEntity} corresponding to {@code airportCode}<br>
     * Entity of the airport is searched from the airport code table inner joined with<br>
     * the prefecture code table<br>
     *
     ...
     * 空港データは空港コード表と都道府県データを結合して取得する.<br>
     * Returns {@code List} of the airport data corresponding to located prefecture<br>
     * List of airports are got from the airport code table inner joined with
     * the prefecture code table<br>
     *
     ...
     * 空港データは空港コード表と都道府県データを結合して取得する.<br>
     * Returns {@code List} of all airport data<br>
     * List of airports are got from the airport code table inner joined with
     * the prefecture code table<br>
     *
     * @return List {@code <PrefectureEntity>} the list of AirportEntity
     */
    List<AirportEntity> getAllAirports();

    /**
     * 新規の空港データを登録する.<br>
     * Registers a new airport with a new code into the airport code table<br>
     *
     ...
     * the code existing in the airport code table<br>
     *
     * @param airportCode new code which is unique value assigned to each airport
     * @param airportName new name of airport
     * @param prefCode    the name of prefecture existing in the prefecture code table
     * @throws NoResourceException    when the airport or the prefecture corresponding
     *                                to the code does not exist
     ...
     * Deletes the airport from the airport code table<br>
     *
     * @param airportCode the code which is unique value assigned to each airport
     * @throws NoResourceException when the airport corresponding to the code does not exist
     */

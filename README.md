...
|Name|Request|Function|Note|
|--|--|--|--|
|getPrefByCode|GET|指定した既存の都道府県コードに対応する都道府県データを返す||
|getPrefByName|GET|指定した既存の都道府県名に対応する都道府県データを返す||
|getAllPrefs|GET|既存の都道府県コードと対応する都道府県データを全て返す||
|createPref|POST|既存とは重複しない都道府県コードとその都道府県名をデータとして追加||
|updatePref|PATCH|指定した既存の都道府県コードに対応する都道府県名を書き換え||
|deletePref|DELETE|指定した既存の都道府県コードに対応する都道府県データ削除|削除対象の都道府県コードを付与されている空港も削除|
